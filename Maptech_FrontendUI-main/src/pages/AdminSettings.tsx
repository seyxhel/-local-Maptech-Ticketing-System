    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card accent>
        ...
        <form onSubmit={handleChangePassword} className="space-y-4 max-w-md">
          ...
          {pwSuccess && <div className="p-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 text-sm">{pwSuccess}</div>}
          <div>
